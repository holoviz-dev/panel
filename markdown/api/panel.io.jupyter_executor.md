...
class panel.io.jupyter_executor.JupyterServerSession(session_id: ID, document: Document, io_loop: Loop \| None = None, token: str \| None = None, executor: \_ServerExecutor \| None = None)
Bases: `ServerSession`
