...
- [panel.theme.base module](panel.theme.base.md)
  ...
  - [Design](panel.theme.base.md#panel.theme.base.Design)
    - [Design.apply()](panel.theme.base.md#panel.theme.base.Design.apply)
    - [Design.apply_bokeh_theme_to_model()](panel.theme.base.md#panel.theme.base.Design.apply_bokeh_theme_to_model)
    - [Design.params()](panel.theme.base.md#panel.theme.base.Design.params)
    - [Design.resolve_resources()](panel.theme.base.md#panel.theme.base.Design.resolve_resources)
...
- [panel.theme.fast module](panel.theme.fast.md)
  ...
  - [FastDarkTheme](panel.theme.fast.md#panel.theme.fast.FastDarkTheme)
    - [FastDarkTheme.bokeh_theme](panel.theme.fast.md#panel.theme.fast.FastDarkTheme.bokeh_theme)
  ...
  - [FastStyle](panel.theme.fast.md#panel.theme.fast.FastStyle)
    - [FastStyle.create_bokeh_theme()](panel.theme.fast.md#panel.theme.fast.FastStyle.create_bokeh_theme)
  ...
  - [FastWrapper](panel.theme.fast.md#panel.theme.fast.FastWrapper)
    - [FastWrapper.select()](panel.theme.fast.md#panel.theme.fast.FastWrapper.select)
...
class panel.theme.Bootstrap(theme=None, **params)
...
class panel.theme.DarkTheme(\*, base_css, bokeh_theme, css, name)
...
`bokeh_theme`` ``=`` ``ClassSelector(class_=(<class`` ``'bokeh.themes.theme.Theme'>,`` ``<class`` ``'str'>),`` ``default=<bokeh.themes.theme.Theme`` ``object`` ``at`` ``0x110037740>,`` ``label='Bokeh`` ``theme')`
...
class panel.theme.DefaultTheme(\*, base_css, bokeh_theme, css, name)
Bases: [Theme](panel.theme.base.md#panel.theme.base.Theme)
...
class panel.theme.Design(theme=None, **params)
Bases: `Parameterized`,
...
|  |  |
|----|----|
| [apply](#panel.theme.Design.apply)(viewable, root\[, isolated\]) | Applies the Design to a Viewable and all it children. |
| [apply_bokeh_theme_to_model](#panel.theme.Design.apply_bokeh_theme_to_model)(model\[, ...\]) | Applies the Bokeh theme associated with this Design system to a model. |
| [params](#panel.theme.Design.params)(viewable\[, doc\]) | Provides parameter values to apply the provided Viewable. |
| [resolve_resources](#panel.theme.Design.resolve_resources)(\[cdn, extras, include_theme\]) | Resolves the resources required for this design component. |
...
class panel.theme.Fast(theme=None, **params)
Bases: [Design](panel.theme.base.md#panel.theme.base.Design)
...
class panel.theme.Inherit
Bases: `object`

Singleton object to declare stylesheet inheritance.

class panel.theme.Material(theme=None, **params)
Bases: [Design](panel.theme.base.md#panel.theme.base.Design)
...
class panel.theme.Native(theme=None, **params)
Bases: [Design](panel.theme.base.md#panel.theme.base.Design)
...
class panel.theme.Theme(\*, base_css, bokeh_theme, css, name)
Bases: `Parameterized`
