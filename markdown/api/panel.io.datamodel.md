...
class panel.io.datamodel.Parameterized(\*, default: Init\[T\] = Intrinsic, help: str \| None = None)
Bases: `Property`
...
class panel.io.datamodel.ParameterizedList(\*, default: Init\[T\] = Intrinsic, help: str \| None = None)
Bases: `Property`
...
(bool, optional) : whether to construct detailed exceptions
...
class panel.io.datamodel.PolarsDataFrame(\*, default: Init\[T\] = Intrinsic, help: str \| None = None)
Bases: `Property`
