...
`default_badges`` ``=`` ``Dict(class_=<class`` ``'dict'>,`` ``default={'pending':`` ``<function`` ``<lambda>`` ``at`` ``0x110576840>,`` ``'running':`` ``<function`` ``<lambda>`` ``at`` ``0x1105768e0>,`` ``'success':`` ``<function`` ``<lambda>`` ``at`` ``0x110576980>,`` ``'failed':`` ``<function`` ``<lambda>`` ``at`` ``0x110576a20>},`` ``label='Default`` ``badges')`
