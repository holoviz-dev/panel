...
async function startApplication() {
  ...
  try {
    await self.pyodide.runPythonAsync(`
      import micropip
      await micropip.install(['https://cdn.holoviz.org/panel/wheels/bokeh-3.10.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.10.0-a.4/dist/wheels/panel-1.10.0a4-py3-none-any.whl', 'pyodide-http', 'hvplot', 'scikit-learn', 'bokeh_sampledata']);
    `);
  } catch(e) {
    console.log(e)
    self.postMessage({
