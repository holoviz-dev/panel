...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/1.4.0-rc.7/dist/wheels/bokeh-3.4.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.4.0-rc.7/dist/wheels/panel-1.4.0rc7-py3-none-any.whl', 'pyodide-http'];
  if (path != null) {
